...
from db.queries.cac import CACQuery
...
def dashboard():
    ...
    try:
        ...
        return render_template('cac/dashboard.html',
...
def application_detail(application_id):
    ...
    try:
        ...
        return render_template('cac/application_detail.html',
                               app=app_data,
                               reviews=reviews,
